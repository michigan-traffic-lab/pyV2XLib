...
from pyv2xlib.RSADecoder import rsa_decoder
...
if __name__ == '__main__':
    hex_rsa = rsa_encoder(
        ...
        position_speed_velocity=163.8,  # optional - boundary test
    ...
    # hex_rsa = '001b317f1a636d1070143ec03a26360ac09ce70fffefd57f5aab8571a55b8448ef1aec75ee77550c03ffe3caa099a04451798c40'

    print('RSA:')
    print(hex_rsa)

    output = rsa_decoder(hex_rsa)
